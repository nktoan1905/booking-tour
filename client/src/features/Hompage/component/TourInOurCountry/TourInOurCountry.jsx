...
import "./../TourInCountry/style.css";
const TourInOutCountry = () => {
  const tour = [
    {
      id: 1,
  ...
  return (
    <div className="mt-5 mb-5 tour" id="tour">
      <div className="heading text-center">
        <span style={{fontSize: "2rem", paddingTop: "2rem", textTransform: "uppercase"}}>du lịch nước ngoài</span>
...
export default TourInOutCountry;
