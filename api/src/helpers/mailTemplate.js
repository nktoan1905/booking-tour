                                ...
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <h1 class="v-text-align v-font-size"
                                      ...
                                      <strong>Verify new Account</strong>
                                    </h1>
                              ...
                              <tbody>
                                <tr>
                                  <td class="v-container-padding-padding"
                                    ...
                                    <h1 class="v-text-align v-font-size"
                                      style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 14px; ">
                                      Please don't give anyone this OTP code:</h1>
                                    ...
                                    <div class="v-text-align" align="center">
                                      ...
                                      <a href="https://www.unlayer.com" target="_blank"
                                        ...
                                        <span style="display:block;padding:10px 20px;line-height:120%;"><span
                                            style="line-height: 16.8px;"><b>${OTP}</b></span></span>
                                      </a>
...
<html>
  ...
  <body>
    ...
    <div class="confirmation" id="confirmation" style="display:block">
      ...
      <p><strong>Content:</strong> <span id="content">${parse(data.content)}</span></p>
    </div>
